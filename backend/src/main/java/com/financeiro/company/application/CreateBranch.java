...
public class CreateBranch {
    ...
    public CreateBranch(CompanyRepository companies, BranchRepository branches) { this.companies = companies; this.branches = branches; }
    @Transactional public Branch execute(Long companyId, String name) {
