...
public record Branch(Long id, Long companyId, String name) {
  public Branch {
    ...
    if (name.length() > 200)
      throw new InvalidNameException("name must have at most 200 characters");
  }

  public static Branch create(Long companyId, String name) {
    return new Branch(null, companyId, name);
  }

  public static Branch rehydrate(Long id, Long companyId, String name) {
    return new Branch(id, companyId, name);
  }
}
